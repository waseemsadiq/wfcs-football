...
class TestRunner
{
    ...
    public function run(): void
    {
        ...
        $testClasses = [
            'Seasons' => SeasonTest::class,
            'Teams' => TeamTest::class,
            'Leagues' => LeagueTest::class,
            'Cups' => CupTest::class,
            'Fixtures' => FixtureTest::class,
        ];
    ...
    private function printSummary(): void
    {
        ...
        printf("║ Success Rate:   %s%d%%" . Colors::CYAN . "                                  ║\n", $statusColor, $percentage);
        printf("║ Duration:       %.2fs                                ║\n", $duration);
