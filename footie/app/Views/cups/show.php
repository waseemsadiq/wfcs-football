                    ...
                    <?php foreach ($rounds as $roundIndex => $round): ?>
                        <div class="flex flex-col min-w-[260px]">
                            ...
                            <h3 class="text-center mb-6 text-sm font-bold text-text-muted uppercase tracking-wider">
                                ...
                                <?php if ($roundDate): ?>
                                    <span class="ml-1 text-xs opacity-75">(<?= date('j M', strtotime($roundDate)) ?>)</span>
                                <?php endif; ?>
                            </h3>
                                            ...
                                            <form
                                                ...
                                                <div class="flex items-center mb-2 pb-2 border-b border-border/50">
                                                    <span class="inline-block w-3 h-3 rounded-full flex-shrink-0 mr-2"
                                                        style="background-color: <?= htmlspecialchars($fixture['homeTeamColour'] ?? '#666') ?>;"></span>
                                                    <span
                                                        class="flex-grow truncate text-sm"><?= htmlspecialchars($fixture['homeTeamName'] ?? 'TBD') ?></span>
                                                ...
                                                <div class="flex items-center mb-3">
                                                    <span class="inline-block w-3 h-3 rounded-full flex-shrink-0 mr-2"
                                                        style="background-color: <?= htmlspecialchars($fixture['awayTeamColour'] ?? '#666') ?>;"></span>
                                                    <span
                                                        class="flex-grow truncate text-sm"><?= htmlspecialchars($fixture['awayTeamName'] ?? 'TBD') ?></span>
