...
<div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="card mb-6">
        <div class="p-6 sm:p-8 lg:p-10">
            ...
            <div
                ...
                <?php if (!empty($fixture['motmPlayerId'])): ?>
                    <div class="flex items-center gap-2 text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-yellow-500 fill-yellow-500"
                            viewBox="0 0 20 20" fill="currentColor">
                            <path
                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                        <span class="font-bold">Man of the Match:
                            <?= htmlspecialchars($fixture['motmPlayerName']) ?>
                        </span>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="card mb-6">
        <div class="p-6 sm:p-8">
            ...
            <?php
            $videos = [];
            // Show live stream only if in progress AND scores haven't been saved yet
            $hasScores = isset($fixture['homeScore']) || (isset($fixture['result']['homeScore']) && $fixture['result']['homeScore'] !== null);

            if ($fixture['status'] === 'in_progress' && $fixture['liveStreamUrl'] && !$hasScores) {
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <?php if (($fixture['motmPlayerId'] ?? null) == $player['id']): ?>
                                                    <span
                                                        class="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-yellow-500/20 text-yellow-600 border border-yellow-500/30 gap-1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 fill-yellow-500"
                                                            viewBox="0 0 20 20" fill="currentColor">
                                                            <path
                                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                        </svg>
