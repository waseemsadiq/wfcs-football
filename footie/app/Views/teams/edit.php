    ...
    <div class="card">
        <form method="POST"
            ...
            <div class="mb-8 p-4 bg-blue-500/10 border border-blue-500/30 rounded">
                <p class="text-sm text-blue-400 mb-3"><strong>Managing Players:</strong></p>
                <p class="text-sm text-text-muted mb-3">Players are now managed separately for better organization.</p>
