    ...
    <header class="bg-surface/80 backdrop-blur-md border-b border-border py-4 mb-8 sticky top-0 z-50">
        <div class="max-w-[1200px] mx-auto px-4 md:px-6 w-full flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center space-x-6">
                ...
                <a href="<?= $basePath ?>/admin/staff"
                    class="<?= ($currentPage ?? '') === 'staff' ? 'text-primary hover:text-green-500' : 'text-text-muted hover:text-primary' ?> font-semibold text-sm transition-colors uppercase tracking-wide">Staff</a>
    ...
    <aside id="mobile-sidebar"
        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 flex flex-col p-6 space-y-4">
                ...
                <a href="<?= $basePath ?>/admin/staff"
                    class="<?= ($currentPage ?? '') === 'staff' ? 'text-primary hover:text-green-500' : 'text-text-muted hover:text-primary' ?> font-semibold text-base transition-colors uppercase tracking-wide">Staff</a>
                <a href="<?= $basePath ?>/admin/seasons"
