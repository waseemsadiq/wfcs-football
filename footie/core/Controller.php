...
class Controller
{
    ...
    public function __construct()
    {
        ...
        $this->basePath = str_replace('\\', '/', $basePath); // Windows compat
    }
    ...
    /**
     * Normalize time to HH:MM:SS format for database storage.
     ...
     */
    protected function findById(array $items, int|string|null $id): ?array
    {
        if ($id === null) {
            return null;
        }
